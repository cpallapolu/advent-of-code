...
They finally notice you at the edge of the grove, your pack almost overflowing from the random **_`star`_** fruit you've been collecting. Behind you, elephants and monkeys explore the grove, looking concerned. Then, the Elves recognize the ash cloud slowly spreading above your recent detour.
...
During the **_first half_** of each round, each Elf considers the eight positions adjacent to them self. If no other Elves are in one of those eight positions, the Elf **_does not do anything_** during this round. Otherwise, the Elf looks in each of four directions in the following order and **_proposes_** moving one step in the **_first valid direction_**:
